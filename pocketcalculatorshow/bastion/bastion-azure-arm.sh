...
echo "Creating deployment for ${environment} ${application} bastion..."
az deployment group create \
	...
	--parameters \
		"location=$region" \
        	...
        	"vmName=$vmName" \
        	"vnetName=$vnetName"
echo "Deployment for ${environment} ${application} bastion is complete."
